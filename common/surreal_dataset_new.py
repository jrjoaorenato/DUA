...
surreal_skeleton = Skeleton(parents=[-1, 0, 1, 2, 3, 0, 4, 5, 6, 0, 7, 8, 9, 8, 10, 11, 12, 8, 13, 14, 15],
                            joints_left=[1, 2, 3, 10, 11, 12],
                            joints_right=[4, 5, 6, 13, 14, 15])
...
used_joints = [0, 2, 5, 8, 1, 4, 7, 3, 9, 15, 13, 18, 20, 14, 19, 21] #todo investigate chaning 9 to 12 if needed
