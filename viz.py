...
def parse_args():
    ...
    # Model arguments
    parser.add_argument('-a', '--architecture', default='linear', type=str, metavar='NAME',
    ...
    parser.add_argument('--viz_bitrate', type=int, default=2000, metavar='N', help='bitrate for mp4 videos')
...
def main(args):
    ...
    if args.architecture == 'linear':
        from models.linear_model import init_weights
        from models.error_prob import LinearModel
...
def evaluate(data_loader, model_pos, device, architecture):
    ...
    for i, (targets_3d, inputs_2d, _) in enumerate(data_loader):
        ...
        if architecture == 'linear':
            ...
            outputs_3d, _ = model_pos(inputs_2d).cpu()
