...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # Evaluate
        error_eval_p1, error_eval_p2, target_eval_p1, target_eval_p2 = evaluate(valid_loader, target_eval_loader, model_pos, device)
...
def evaluate(data_loader, data_loader_target, model_pos, device):
    batch_time = AverageMeter()
    data_time = AverageMeter()
    epoch_loss_3d_pos = AverageMeter()
    ...
    bar.finish()
    return epoch_loss_3d_pos.avg, epoch_loss_3d_pos_procrustes.avg, epoch_loss_3d_tgt.avg, epoch_loss_3d_procrustes_tgt.avg
